(function (global, factory) {
  ...
  (global = global || self, global.apira = factory());
  ...
  class APIra {
    ...
    _request () {
      ...
      const fn = koaCompose([...this._queueHooks, requestHook]);
      const context = {
        response: null,
        APIra: this
      };
    ...
    options (options) {
      this._config = umd(this._config, options);
      return this
    }
    ...
    url (path) {
      const apira = this._copy();
      apira._genUriFn = pathToRegexp_1.compile(path);
      return apira
    }
    params (params) {
    ...
    inspect () {
      return cloneDeep_1(this._config)
    }
    REQUEST (method) {
